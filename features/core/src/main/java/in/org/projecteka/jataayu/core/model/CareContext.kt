...
open class CareContext(@SerializedName("referenceNumber") open val referenceNumber: String, @SerializedName("display") open val display: String): BaseObservable(), IDataBindingModel {
